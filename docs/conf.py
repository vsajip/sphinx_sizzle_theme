...
# -*- coding: utf-8 -*-
#
# Sizzle documentation build configuration file, created by
...
CODE = os.path.join(HERE, '..', 'sphinx_sizzle_theme')
...
project = 'Sizzle'
copyright = '2020-%s, Vinay Sajip' % datetime.date.today().year
author = 'Vinay Sajip'
...
from sphinx_sizzle_theme import __version__ as release
...
#
html_theme = os.environ.get('DOCS_THEME', 'sizzle')
...
latex_documents = [
    (master_doc, 'Sizzle.tex', 'Sizzle Documentation',
     'Vinay Sajip', 'manual'),
]
...
man_pages = [
    (master_doc, 'sizzle', 'Sizzle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sizzle', 'Sizzle Documentation',
     author, 'Sizzle', 'One line description of project.',
     'Miscellaneous'),
]
